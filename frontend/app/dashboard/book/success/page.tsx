      ...
      <div className="animate-fade-up" style={{ width: "100%" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{
            ...
            background: "rgba(61,184,122,0.12)", border: "2px solid rgba(61,184,122,0.35)",
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: 14, lineHeight: 1.6 }}>
            Your private screening session is booked.<br />
            We&apos;ll SMS you 15 minutes before it starts.
          </p>
        </div>
